...
@section('page_title', 'Charts-admin | Frontier Semiconductor')

@section('admin_charts_page')
...
<script src="{{URL::to('fsm_admin/assets/libs/chart/matrix.interface.js')}}"></script>
<script src="{{URL::to('fsm_admin/assets/libs/chart/jquery.peity.min.js')}}"></script>
<script src="{{URL::to('fsm_admin/assets/libs/chart/matrix.charts.js')}}"></script>
<script src="{{URL::to('fsm_admin/assets/libs/chart/jquery.flot.pie.min.js')}}"></script>

<script src="{{URL::to('fsm_admin/assets/libs/chart/turning-series.js')}}"></script>
